    ...
    _getLocation = () => {
        try {
            this.locationSubcribe = RNLocation.subscribeToLocationUpdates(
                locations => {
                    console.log('lat, long: ',locations[0].latitude, locations[0].longitude)
        ...
        return (
            <View style={styles.container}>
                ...
                <TouchableOpacity
                    style={styles.txt}
                    onPress={
                        () => this.props.navigation.navigate('TextTranslator')
                    }
                >
                    <Text style={{ color: 'gray', fontSize: 25, }}>번역할 단어를 입력해주세요.</Text>
                </TouchableOpacity>
                <TouchableOpacity
                    style={styles.cameraBtn}
                    onPress={
                        () => this.props.navigation.navigate('CameraTranslator')
                    }
                >
                    <Image
                        style={styles.icon}
                ...
                <TouchableOpacity
                    ...
                    onPress={
                        () => this.props.navigation.navigate('ImageTranslator')
                    }
                >
                    <Image
                        style={styles.icon}
                ...
                <TouchableOpacity
                    ...
                    onPress={
                        () => this.props.navigation.navigate('VoiceTranslator')
                    }
                >
                    <Image
                        style={styles.icon}
